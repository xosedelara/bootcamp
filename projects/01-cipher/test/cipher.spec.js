...
describe('cipher', () => {
  ...
  describe('cipher.encode', () => {
    ...
    it('should return "234" for "012"', () => {
      expect(cipher.encode(2, '012')).toBe('234');
    });
    it('should return "$%&" for ""#$"', () => {
      expect(cipher.encode(2, '"#$')).toBe('$%&');
    });
    it('should return "`" for "^"', () => {
      expect(cipher.encode(2, '^')).toBe('`');
    });
  ...
  describe('cipher.decode', () => {
    ...
    it('should return "012" for "234"', () => {
      expect(cipher.decode(2, '234')).toBe('012');
    });
    it('should return ""#$" for "$%&"', () => {
      expect(cipher.decode(2, '$%&')).toBe('"#$');
    });
    it('should return "^" for "`"', () => {
      expect(cipher.decode(2, '`')).toBe('^');
    });
