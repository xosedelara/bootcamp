...
const cipher = {
  encode: (offset, textToCipher) =>{
    let cipheredMsg='';
    if (textToCipher===null || textToCipher=== ""){
    throw TypeError("Ingresa por favor un texto a cifrar");
    }else{
  ...
  decode: (offset, textToDecipher) =>{
    let decipheredMsg='';
    if (textToDecipher.value===null || textToDecipher=== ""){
      throw TypeError("Ingresa por favor un texto a decifrar");
      }else{
            ...
            if (asciiNum >= 65 && asciiNum <= 90){
              ...
              if (asciiNum>=48 && asciiNum <= 57){
                ...
                if(asciiNum>=34 && asciiNum <= 47){
                  ...
                  if(asciiNum>=91 && asciiNum<=96){
                    decipheredMsg += String.fromCharCode((asciiNum-9691 - parseInt(offset))%6 + 91);
                  }else{
                    if(asciiNum>=123 && asciiNum<=126){
